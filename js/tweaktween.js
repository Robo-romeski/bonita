$(function(){
				...
				var $demoText = $("a#button,navbar-brand").css("font-size", "50px");
...
tl.staggerFrom(chars, 0.8, {opacity:0.4, scale:1, y:180, rotationX:180, transformOrigin:"0% 50% -50",  ease:Back.easeOut}, .09, "+=0");
